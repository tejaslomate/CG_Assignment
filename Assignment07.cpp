...
char turn = 'X';
bool draw = false;
//Fucntion to show the current status of the gaming board
void display_board(){
//Rander Game Board LAYOUT
cout<<"PLAYER - 1 [X]t PLAYER - 2 [0]nn";
cout<<"tt | | n";
cout<<"tt "<<board[0][0]<<" | "<<board[0][2]<<" n";
cout<<"tt___|___|___n";
cout<<"tt | | n";
...
cout<<"ntPlayer - 2 [0] turn : ";
}
//Taking input from user 
//updating the board according to choice and reassigning the turn start
cin>> choice;
//switch case to get which row and colums will be update
switch(choice){
...
//updation the position for 'X' symbol if
...
//Function to get the game status e.g.GAME WON, GAME DRAW IN CONTINUE MODE
...
return true;
//checking the if game already drawss
draw = true;
return false;
}
